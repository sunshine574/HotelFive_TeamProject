...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$('#signUpBtn').click(function(){
			...
			if(idFlag && pwFlag && pw2Flag && nameFlag && authFlag && phoneFlag && addrFlag){
		...
		$('#agreeBtn').click(function() {
			...
			$("#page-box-2").css("display", "inline");
			$("#page-box-1").css("display", "none");
		});
    		...
    		<div id="page-box-1" class="page-box-1">
    			...
    			<div class="termsOfUse">
	    			...
	    			<textarea cols="80" rows="10" readonly style="width: 1200px;">
	    				호텔 예약 사이트 「  호텔 파이브 」회원 약관
	    				
	    				제 1조(목적)
	    				이 약관은 호텔 파이브 회사(전자상거래 사업자)가 운영하는 호텔 파이브 몰(이하 "몰"이라 한다)에서 제공
    			...
    			<p>귀하께서는 호텔파이브에서 위와 같이 수집하는 개인정보에 대해, 동의하지 않거나 개인정보를 기재하지 않음으로써 거부할 수 있습니다.<p>
    		...
    		<div id="page-box-2" class="page-box-2">
				...
				<div class="register-box">
					<table id="register-table">
						...
						<tr>
							<td>이름</td>
							<td><input id="mName" type="text" name="mName" /><br/></td>
						</tr>
						<tr>
							<td>이메일</td>
							<td>
